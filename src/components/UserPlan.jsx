  ...
  return (
    <div id="user-plan-wrapper">
      <div className="user-plans">
        <div
          className={`user-plan ${userPlanSelected.userPlanTitle === "arcade" ? "user-plan__selected" : ""}`}
          data-title="arcade"
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">{arcade.userPlanTitle}</p>
            <p className="user-plan__price">${arcade.userPlanPrice}/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
        <div
          className={`user-plan ${userPlanSelected.userPlanTitle === "advanced" ? "user-plan__selected" : ""}`}
          data-title="advanced"
          onClick={userPlanHandler}>
          <div className="user-plan__icon">
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">{advanced.userPlanTitle}</p>
            <p className="user-plan__price">${advanced.userPlanPrice}/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
        <div
          className={`user-plan ${userPlanSelected.userPlanTitle === "pro" ? "user-plan__selected" : ""}`}
          data-title="pro"
          onClick={userPlanHandler}>
          <div className="user-plan__icon">
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">{pro.userPlanTitle}</p>
            <p className="user-plan__price">${pro.userPlanPrice}/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
      </div>
