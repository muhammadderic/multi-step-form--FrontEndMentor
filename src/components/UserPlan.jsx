  ...
  return (
    <div id="user-plan-wrapper">
      <div className="user-plans">
        <div className={`user-plan ${userPlanState.includes("arcade") ? "user-plan__selected" : ""}`} data-title="arcade" onClick={userPlanHandler}>
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">Arcade</p>
            <p className="user-plan__price">$9/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
        <div className={`user-plan ${userPlanState.includes("advanced") ? "user-plan__selected" : ""}`} data-title="advanced" onClick={userPlanHandler}>
          <div className="user-plan__icon">
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">Advanced</p>
            <p className="user-plan__price">$12/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
        <div className={`user-plan ${userPlanState.includes("pro") ? "user-plan__selected" : ""}`} data-title="pro" onClick={userPlanHandler}>
          <div className="user-plan__icon">
          ...
          <div className="user-plan__detail">
            <p className="user-plan__title">Pro</p>
            <p className="user-plan__price">$15/mo</p>
            <p className="user-plan__trial">2 months free</p>
          </div>
        </div>
      </div>
