  ...
  return (
    <div id="user-plan-wrapper">
      <div className="user-plans">
        <div className="user-plan" data-title="arcade" onClick={userPlanHandler}>
        ...
        <div className="user-plan" data-title="advanced" onClick={userPlanHandler}>
          <div className="user-plan__icon">
        ...
        <div className="user-plan" data-title="pro" onClick={userPlanHandler}>
          <div className="user-plan__icon">
